...
<html lang="en">
  <head>
    <meta charset="utf-8" />
    <title>UTE fashion - Online Shop Website Template</title>
      ...
      >
        <div class="col-lg-4">
          <a href="" class="text-decoration-none">
            <span class="h1 text-uppercase text-primary bg-dark px-2">UTE</span>
        ...
        <div class="col-lg-3 d-none d-lg-block">
          ...
          >
            <h6 class="text-dark m-0">
              <i class="fa fa-bars mr-2"></i>Sản phẩm bán chạy
            </h6>
        ...
        <div class="col-lg-9">
          ...
          >
            <a href="" class="text-decoration-none d-block d-lg-none">
              <span class="h1 text-uppercase text-dark bg-light px-2">UTE</span>
